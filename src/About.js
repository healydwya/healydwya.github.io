  ...
  return (
    <div className="about-page scene_element scene_element scene_element--fadeinup">
      ...
      <div className="about-text">
        ...
        <div className="col">
          <p> With <b>4+ years of experience as a UX researcher + engineer </b> along with a background in urban planning, my passion is building technology to improve the systems that shape our world. </p>
          <p> Having worked as both a software engineer and researcher, my strengths lie in <b> technical HCI</b> and <b> research through prototyping. </b>I bring a unique perspective to communicating insights and brainstorming solutions with product managers, designers, researchers, and engineers. </p>
